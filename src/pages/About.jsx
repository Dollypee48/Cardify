export default function About() {
  return (
    <div className="min-h-screenbg-gray-200 dark:bg-gray-800 py-12 px-6">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-10">
        ...
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          Designed for <span className="font-semibold text-gray-900">freelancers, HR teams, small businesses, and event coordinators</span>, Cardify empowers you to represent your brand with clean, customizable digital cards. Upload photos, add brand colors, select fonts, and instantly preview your card.
        </p>
